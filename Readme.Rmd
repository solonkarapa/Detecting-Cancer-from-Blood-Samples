...
# Aim  
To develop and evaluate mathematical/statistical models capable of detecting early-stage cancers from cfDNA data by integrating and analysing weak signal features across various cancer types. 
...
include_graphics(paste0(figures_path, "fragmentation_density.png"))
```
